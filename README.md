...
2. Run `npm init`. When that's finished, install and save these npm packages:
   ...
   2. express-handlebars (optional)

   3. mongoose (or mongojs)

   4. cheerio

   5. axios

3. **NOTE**: If you want to earn complete credit for your work, you must use these packages in your assignment.
